...
public class QueryErp {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(QueryErp.class);
...
//		this.url = "jdbc:sqlserver://192.168.2.254:1433;databasename=roadage12";  // jdbc连接
//		this.name = "sa"; // name
//		this.password ="roadagefy"; // password
		
		this.forname = "com.microsoft.sqlserver.jdbc.SQLServerDriver";// jdbc连接
		this.url = "jdbc:sqlserver://EDWIN-ZIST:1433;databasename=ACM";  // jdbc连接
		this.name = "sa"; // name
